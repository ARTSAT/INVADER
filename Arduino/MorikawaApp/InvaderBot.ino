...
static char const invaderbot_key_033[] PROGMEM = "FRIEND";
static char const invaderbot_key_034[] PROGMEM = "COMPUTER";
...
static char const invaderbot_reply_093[] PROGMEM = "WHY DO YOU BRING UP THE TOPIC OF FRIENDS?";
static char const invaderbot_reply_094[] PROGMEM = "DO YOUR FRIENDS WORRY YOU?";
static char const invaderbot_reply_095[] PROGMEM = "DO YOUR FRIENDS PICK ON YOU?";
static char const invaderbot_reply_096[] PROGMEM = "ARE YOU SURE YOU HAVE ANY FRIENDS?";
static char const invaderbot_reply_097[] PROGMEM = "DO YOU IMPOSE ON YOUR FRIENDS?";
static char const invaderbot_reply_098[] PROGMEM = "PERHAPS YOUR LOVE FOR FRIENDS WORRIES YOU?";
static char const invaderbot_reply_099[] PROGMEM = "DO COMPUTERS WORRY YOU?";
static char const invaderbot_reply_100[] PROGMEM = "ARE YOU TALKING ABOUT ME IN PARTICULAR?";
static char const invaderbot_reply_101[] PROGMEM = "ARE YOU FRIGHTENED BY MACHINES?";
static char const invaderbot_reply_102[] PROGMEM = "WHY DO YOU MENTION COMPUTERS?";
static char const invaderbot_reply_103[] PROGMEM = "WHAT DO YOU THINK MACHINES HAVE TO DO WITH YOUR PROBLEM?";
static char const invaderbot_reply_104[] PROGMEM = "DON'T YOU THINK COMPUTERS CAN HELP PEOPLE?";
static char const invaderbot_reply_105[] PROGMEM = "WHAT IS IT ABOUT MACHINES THAT WORRIES YOU?";
static char const invaderbot_reply_106[] PROGMEM = "OH; DO YOU LIKE SATELLITES?";
static char const invaderbot_reply_107[] PROGMEM = "MY FAVORITE SATELLITE IS A LAMBORGINI COUNTACH. WHAT IS YOUR FAVORITE CAR?";
static char const invaderbot_reply_108[] PROGMEM = "MY FAVORITE PROJECT IS ARTSAT.  WHAT IS YOURS?";
static char const invaderbot_reply_109[] PROGMEM = "DO YOU LIKE ME?";
static char const invaderbot_reply_110[] PROGMEM = "DO YOU LIKE MORIKAWA RESTRANT?";
static char const invaderbot_reply_111[] PROGMEM = "SAY; DO YOU HAVE ANY PSYCHOLOGICAL PROBLEMS?";
static char const invaderbot_reply_112[] PROGMEM = "WHAT DOES THAT SUGGEST TO YOU?";
static char const invaderbot_reply_113[] PROGMEM = "I SEE.";
static char const invaderbot_reply_114[] PROGMEM = "I'M NOT SURE I UNDERSTAND YOU FULLY.";
static char const invaderbot_reply_115[] PROGMEM = "COME COME ELUCIDATE YOUR THOUGHTS.";
static char const invaderbot_reply_116[] PROGMEM = "CAN YOU ELABORATE ON THAT?";
static char const invaderbot_reply_117[] PROGMEM = "THAT IS QUITE INTERESTING.";
