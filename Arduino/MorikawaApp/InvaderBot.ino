...
static char const invaderbot_reply_101[] PROGMEM = "ARE YOU FRIGHTENED BY ROCKETS?";
static char const invaderbot_reply_102[] PROGMEM = "WHY DO YOU MENTION ROCKETS?";
static char const invaderbot_reply_103[] PROGMEM = "WHAT DO YOU THINK ROCKETS HAVE TO DO WITH YOUR PROBLEM?";
static char const invaderbot_reply_104[] PROGMEM = "DON'T YOU THINK ROCKETS CAN HELP PEOPLE?";
static char const invaderbot_reply_105[] PROGMEM = "WHAT IS IT ABOUT ROCKETS THAT WORRIES YOU?";
static char const invaderbot_reply_106[] PROGMEM = "OH; DO YOU LIKE SATELLITES?";
static char const invaderbot_reply_107[] PROGMEM = "MY FAVORITE SATELLITE IS INVADER. WHAT IS YOUR FAVORITE SATELLITE?";
